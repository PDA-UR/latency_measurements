...
#ax = sns.stripplot(values, hue=None, jitter=False, dodge=False, color=None, palette="Set2", size=10, marker="D", orient="v", alpha=0.25)
ax = sns.swarmplot(values, hue=None, palette="Set2", size=10, marker="D", orient="v", alpha=0.25)
...
if len(sys.argv[1:]) == 1: # only one file
    ...
    plt.savefig(cur_dir + "/scatterplot/" + png_filename)
else:
    plt.show()
